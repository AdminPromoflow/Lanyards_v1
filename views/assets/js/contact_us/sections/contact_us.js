class ContactUs {
  ...
  validateFields() {
    const name = nameContactUs.value.trim();
    const email = emailContactUs.value.trim();
    const phone = phoneContactUs.value.trim();
    const message = messageContactUs.value.trim();
    ...
    if (name === '') {
      ...
      this.setErrorBorder(nameContactUs);
    }

    // Validate email field
    if (email === '') {
      errors.push('The "Email" field cannot be empty.');
      this.setErrorBorder(emailContactUs);
    ...
    if (phone === '') {
      ...
      this.setErrorBorder(phoneContactUs);
    ...
    if (message === '') {
      ...
      this.setErrorBorder(messageContactUs);
    }
  ...
  resetBorders() {
    const inputs = [nameContactUs, emailContactUs, phoneContactUs, messageContactUs];
...
const button_contact_us = document.getElementById('button_contact_us');

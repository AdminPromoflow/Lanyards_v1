class ArtworkDetailsClass {
  ...
  //  this.resizeWithLanyardText(descriptionObj);
    ...
    if (Array.isArray(texts) && texts.length > 0) {
      ...
      textClass.setSpaceBetweenText(parseFloat(textData.spaceBetweenText * 5));
      textClass.setSpaceAlongLanyard(parseFloat(textData.spaceAlongLanyard * 5));
      textClass.setColourText(textData.colourText);
      textClass.setFontFamilyText(textData.fontFamilyText);
      textClass.setSizeText(parseFloat(textData.sizeText * 5));
      ...
      textClass.setTextPosition(parseFloat(textData.textPosition * 5));

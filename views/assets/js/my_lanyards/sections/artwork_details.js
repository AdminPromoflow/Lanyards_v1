class ArtworkDetailsClass {
  ...
  //  this.resizeWithLanyardText(descriptionObj);
    ...
    if (Array.isArray(texts) && texts.length > 0) {
      ...
      textClass.setSpaceBetweenText(parseFloat(textData.spaceBetweenText * 3));
      textClass.setSpaceAlongLanyard(parseFloat(textData.spaceAlongLanyard * 3));
      textClass.setColourText(textData.colourText);
      textClass.setFontFamilyText(textData.fontFamilyText);
      textClass.setSizeText(parseFloat(textData.sizeText * 3));
      ...
      textClass.setTextPosition(parseFloat(textData.textPosition * 3));

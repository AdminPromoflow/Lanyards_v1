...
//option.selected = true;
  ...
  /**
   * Displays the background container at the specified index and hides all others.
   *
   * @param {number} containerIndex - The index of the background container to be displayed.
   */
   activateContainerBackground(containerIndex) {
    // Select all elements with the class 'containers_boxes_background'.
    ...
    for (let i = 0; i < backgroundContainers.length; i++) {
      backgroundContainers[i].style.display = "none";
    }

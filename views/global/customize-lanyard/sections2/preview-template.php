...
<section id="preview-template-class" class="preview-template-class">
  ...
  <div class="container-preview-template">
    ...
    <div class="super-lanyard">
      ...
      <div class="left-super-lanyard left-super-lanyard-two-end-30mm">
        <!-- Rendered preview for the left segment -->
      </div>
      <!-- Right part of the standard lanyard (for one-end, 10mm type) -->
      <div class="right-super-lanyard right-super-lanyard-two-end-30mm">
    ...
    <div class="super-lanyard-artwork">
      ...
      <div class="left-super-lanyard-artwork left-super-lanyard-two-end-30mm-artwork">
        <!-- Rendered artwork preview for the left segment -->
      </div>
      <!-- Right part of the artwork-mode lanyard -->
      <div class="right-super-lanyard-artwork right-super-lanyard-two-end-30mm-artwork">

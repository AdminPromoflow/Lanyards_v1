  ...
  <div class="super-lanyard-manual" id="super-lanyard-manual">
    <div class="" id="left-super-lanyard-manual">
      <div class="text-lanyard">
        <h1 class="rotate-180 ">hola1</h1>
        <h1 class="rotate-180 ">hola2</h1>
        <h1 class="rotate-180 ">hola3</h1>
        <h1 class="rotate-180 ">hola4</h1>
        <h1 class="rotate-180 ">hola5</h1>
        <h1 class="rotate-180 ">hola6</h1>
      </div>
    </div>

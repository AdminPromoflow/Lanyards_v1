<link rel="stylesheet" href="../../views/assets/css/global/customize-lanyard/sections/checkout.css">
<section class="checkout section">
  <h2 class="name-section-customize-lanyard">Buy Now or Add to Cart</h2>
  <br>
  ...
  <div id="containers_boxes_checkout" class="containers_boxes_checkout">
    ...
    <div class="preview_checkout">
      <h3 class="dataAccessories">First Lanyard</h3>
      <img class="imgaccessories" src="../../views/assets/img/global/customize-lanyard/sections/checkout/lanyardIcon.png" alt="">
    ...
    <div class="subcontainers_boxes_preview_checkout">
...
<script src="../../views/assets/js/customize-lanyard/sections/checkout.js" type="text/javascript"></script>

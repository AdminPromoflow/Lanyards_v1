...
<section class="section_contact_us">
  ...
  <div class="container_contact_us">
    <div class="box_contact_us">
      <input type="text" id="nameContactUsHome" placeholder="Name" >
      <input type="email"  id="emailContactUsHome" placeholder="Email address" >
      <input type="tel"  id="phoneContactUsHome" placeholder="Contact number" >
      <textarea  id="messageContactUsHome" placeholder="Tell us how we can assist you..." rows="3" ></textarea>
    </div>
    <div class="box_contact_us">
      <div id="map3"></div>
    </div>

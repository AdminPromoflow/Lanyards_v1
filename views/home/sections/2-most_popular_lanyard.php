  ...
  <div class="container_most_popular_lanyard">
    ...
    <div class="subcontainer_most_popular_lanyard">
      <div class="box_display_most_popular_lanyard">
        <h2>Material</h2>
        <img src="../../views/assets/img/home/2-most_popular_lanyard/Material-5-Dye-sub-Recycled-PET.jpg" alt="">
        <h3>Dye-sublimation</h3>
      ...
      <div class="box_display_most_popular_lanyard">
        ...
        <img src="../../views/assets/img/home/2-most_popular_lanyard/one-end.png" alt="">
        <h3>Single ended</h3>
        <p>A lanyard type one end is a strap with a single functional end for holding accessories or ID cards.</p>
      </div>
      <div class="box_display_most_popular_lanyard">
        <h2>Width</h2>
        <img src="../../views/assets/img/home/2-most_popular_lanyard/one-end-25mm.png" alt="">
        <h3>20mm</h3>
        <p>A lanyard one end 20mm is a strap, 20mm wide, with a single functional end for attachments.</p>
      </div>
      <div class="box_display_most_popular_lanyard">
        <h2>Side Printed</h2>
        <img src="../../views/assets/img/home/2-most_popular_lanyard/two-side.png" alt="">
        <h3>Both sides</h3>
      ...
      <div class="box_display_most_popular_lanyard">
        <h2>Clip</h2>
        <img src="../../views/assets/img/home/2-most_popular_lanyard/dog_clip.png" alt="">
        <h3>Dog</h3>

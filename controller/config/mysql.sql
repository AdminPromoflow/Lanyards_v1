...
/*  Created On : 10-Mar-2025 6:27:54 AM 				*/
/*  DBMS       : MySql 						*/
/* ---------------------------------------------------- */
...
(
	`idJobs` INT NOT NULL,
	`timesImage` INT NULL,
	`imageSize` FLOAT(8,2) NULL,
	`spaceBetweenImage` FLOAT(8,2) NULL,
	`imageRotation` FLOAT(8,2) NULL,
	`spaceAlongLanyard` FLOAT(8,2) NULL,
	`linkImage` TEXT NULL,
	`imagePosition` FLOAT(8,2) NULL,

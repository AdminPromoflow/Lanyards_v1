...
/*  Created On : 07-May-2025 5:34:28 PM 				*/
/*  DBMS       : MySql 						*/
/* ---------------------------------------------------- */
...
ALTER TABLE `Jobs`
 ADD INDEX `IXFK_Jobs_LanyardTypes` (`idLanayardType` ASC)
;
...
ALTER TABLE `Jobs`
 ADD CONSTRAINT `FK_Jobs_LanyardTypes`
	FOREIGN KEY (`idLanayardType`) REFERENCES `LanyardTypes` (`idLanayardType`) ON DELETE Restrict ON UPDATE Restrict
;
